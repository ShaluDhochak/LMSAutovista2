...
public class HomeVisitDashboardActivity extends AppCompatActivity implements IView.DashboardDetailView{
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(this)) {
            ...
            dashboardPresenter.getHomevisitDashboardList(role, user_id,HomeVisitDashboardActivity.this);
        } else {
            Toast.makeText(HomeVisitDashboardActivity.this, "Check Internet connectivity.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void ShowDashboardDetailCount(CallingTaskNewLeadBean jsonObject) {
        try {
            ...
            PendingDashboardAdapter dashboardAdapter = new PendingDashboardAdapter(HomeVisitDashboardActivity.this, jsonObject.getLead_details());
            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(HomeVisitDashboardActivity.this, LinearLayoutManager.VERTICAL, false);
