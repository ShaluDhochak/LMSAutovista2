...
public class EscalationLevel1Adapter extends RecyclerView.Adapter<EscalationLevel1Adapter.MyViewHolder>{

    private List<CallingTaskNewLeadBean.Lead_Details> dashboardList;
    Context context;

    public EscalationLevel1Adapter(Context context,List<CallingTaskNewLeadBean.Lead_Details> dashboardList){
        this.context = context;
        this.dashboardList = dashboardList;
    }

    @Override
    public EscalationLevel1Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.followup_detail_listview, parent, false);
        return new EscalationLevel1Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(EscalationLevel1Adapter.MyViewHolder holder,final int position) {
