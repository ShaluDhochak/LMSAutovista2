 ...
 */
public class TestDriveTodayFragment extends Fragment  implements IView.NewLeadCallingTaskView{
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(getActivity())) {
            newLeadCallingTaskPresenter.getTestDriveTodayList(getActivity());
        } else {
