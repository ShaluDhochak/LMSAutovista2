...
public class EscalationLevel2Activity extends AppCompatActivity  implements IView.DashboardDetailView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lmsheading_TextView.setText("Escalation Level 2 Leads");
        //  bean = UnassignedLeadDashboardActivity.this.getIntent().getParcelableExtra("bean");
        dashboardPresenter = new DashboardDetailPresenter(EscalationLevel2Activity.this);

        progressDialog = new ProgressDialog(EscalationLevel2Activity.this);
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(this)) {
            ...
            dashboardPresenter.getEscalationLevel2DashboardList(role, user_id,EscalationLevel2Activity.this);
        } else {
            Toast.makeText(EscalationLevel2Activity.this, "Check Internet connectivity.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void ShowDashboardDetailCount(CallingTaskNewLeadBean jsonObject) {
        try {
            ...
            PendingDashboardAdapter dashboardAdapter = new PendingDashboardAdapter(EscalationLevel2Activity.this, jsonObject.getLead_details());
            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(EscalationLevel2Activity.this, LinearLayoutManager.VERTICAL, false);
