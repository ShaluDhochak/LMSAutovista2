...
import com.excell.lms.lmsautovista.Presenter.AllLeadCallingTaskPresenter;
...
public class AllLeadFragment extends Fragment implements IView.AllLeadCallingTaskView{
    ...
    public void getSearchBtn(){
     ...
     //   if (search_EditText.getText().length()>0){
            ...
            loadMoreAllLead_btn.setVisibility(View.GONE);
            loadLessAllLead_btn.setVisibility(View.GONE);

            allLeadCallingTaskPresenter.getAllSearchedLeadCallingTask(contact_no,"-1",getActivity());
       // }else{
        //    Toast.makeText(getActivity(), "Please Type Contact no.", Toast.LENGTH_SHORT).show();
       // }
    }
