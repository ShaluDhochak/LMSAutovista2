...
public class ShowroomVisitAdapter  extends RecyclerView.Adapter<ShowroomVisitAdapter.MyViewHolder>{

    private List<CallingTaskNewLeadBean.Lead_Details> dashboardList;
    Context context;

    public ShowroomVisitAdapter(Context context,List<CallingTaskNewLeadBean.Lead_Details> dashboardList){
        this.context = context;
        this.dashboardList = dashboardList;
    }

    @Override
    public ShowroomVisitAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.followup_detail_listview, parent, false);
        return new ShowroomVisitAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(ShowroomVisitAdapter.MyViewHolder holder,final int position) {
