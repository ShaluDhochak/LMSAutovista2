...
public class EvaluationDashboardActivity extends AppCompatActivity  implements IView.DashboardDetailView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lmsheading_TextView.setText("Evaluation Leads");
        //  bean = UnassignedLeadDashboardActivity.this.getIntent().getParcelableExtra("bean");
        dashboardPresenter = new DashboardDetailPresenter(EvaluationDashboardActivity.this);

        progressDialog = new ProgressDialog(EvaluationDashboardActivity.this);
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(this)) {
            ...
            dashboardPresenter.getEvaluationTodayDashboardList(role, user_id,EvaluationDashboardActivity.this);
        } else {
            Toast.makeText(EvaluationDashboardActivity.this, "Check Internet connectivity.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void ShowDashboardDetailCount(CallingTaskNewLeadBean jsonObject) {
        try {
            ...
            PendingDashboardAdapter dashboardAdapter = new PendingDashboardAdapter(EvaluationDashboardActivity.this, jsonObject.getLead_details());
            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(EvaluationDashboardActivity.this, LinearLayoutManager.VERTICAL, false);
