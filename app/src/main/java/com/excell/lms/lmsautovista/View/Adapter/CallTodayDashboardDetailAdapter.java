...
public class CallTodayDashboardDetailAdapter extends RecyclerView.Adapter<CallTodayDashboardDetailAdapter.MyViewHolder>{
    ...
    @Override
    public CallTodayDashboardDetailAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.followup_detail_listview, parent, false);
        return new CallTodayDashboardDetailAdapter.MyViewHolder(itemView);
    }
