...
public class FollowUpDetailsComplainAdapter  extends RecyclerView.Adapter<FollowUpDetailsComplainAdapter.MyViewHolder>{

    private List<FollowUpDetailsBean.FollowUp_details> dashboardList;
    Context context;

    public FollowUpDetailsComplainAdapter(Context context,List<FollowUpDetailsBean.FollowUp_details> dashboardList){
        this.context = context;
        this.dashboardList = dashboardList;
    }

    @Override
    public FollowUpDetailsComplainAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.followup_details_layout, parent, false);
        return new FollowUpDetailsComplainAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(FollowUpDetailsComplainAdapter.MyViewHolder holder, final int position) {
        final FollowUpDetailsBean.FollowUp_details bean = dashboardList.get(position);
        holder.remarkFollowUpDetailsString_TextView.setText(bean.getF_comment());
        ...
        holder.callDateFollowUpDetailsString_TextView.setText(bean.getC_date());
        holder.followUpByFollowUpDetailsString_TextView.setText(bean.getFname() + " "+bean.getLname());
        holder.callTimeFollowUpDetailsString_TextView.setText(bean.getCreated_time());
