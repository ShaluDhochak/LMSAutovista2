...
import com.excell.lms.lmsautovista.View.Adapter.PendingNewDashboardDetailAdapter;
...
public class PendingNewLeadActivity extends AppCompatActivity implements IView.DashboardDetailView{
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(this)) {
            ...
            dashboardPresenter.getPendingNewDashboardDetailList(role, user_id,PendingNewLeadActivity.this);
        } else {
