...
public class HomeVisitTodayFragment extends Fragment implements IView.NewLeadCallingTaskView{
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(getActivity())) {
            newLeadCallingTaskPresenter.getHomeVisitTodayList(getActivity());
        } else {
