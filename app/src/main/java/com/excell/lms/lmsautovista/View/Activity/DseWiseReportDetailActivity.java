...
public class DseWiseReportDetailActivity extends AppCompatActivity {
    ...
    @BindView(R.id.separator0_view)
    TextView separator0_view;
    ...
    private void setTextValue(){
        ...
        if (bean.getFname().toString().equals("")){
            separator0_view.setVisibility(View.GONE);
            nameDseWiseLeadReport_txtView.setVisibility(View.GONE);
