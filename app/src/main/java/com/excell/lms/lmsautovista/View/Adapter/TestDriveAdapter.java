...
public class TestDriveAdapter extends RecyclerView.Adapter<TestDriveAdapter.MyViewHolder>{

    private List<CallingTaskNewLeadBean.Lead_Details> dashboardList;
    Context context;

    public TestDriveAdapter(Context context,List<CallingTaskNewLeadBean.Lead_Details> dashboardList){
        this.context = context;
        this.dashboardList = dashboardList;
    }

    @Override
    public TestDriveAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.followup_detail_listview, parent, false);
        return new TestDriveAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(TestDriveAdapter.MyViewHolder holder,final int position) {
