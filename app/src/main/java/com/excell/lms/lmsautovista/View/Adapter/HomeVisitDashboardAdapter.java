...
public class HomeVisitDashboardAdapter extends RecyclerView.Adapter<HomeVisitDashboardAdapter.MyViewHolder>{

    private List<CallingTaskNewLeadBean.Lead_Details> dashboardList;
    Context context;

    public HomeVisitDashboardAdapter(Context context,List<CallingTaskNewLeadBean.Lead_Details> dashboardList){
        this.context = context;
        this.dashboardList = dashboardList;
    }

    @Override
    public HomeVisitDashboardAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.followup_detail_listview, parent, false);
        return new HomeVisitDashboardAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(HomeVisitDashboardAdapter.MyViewHolder holder,final int position) {
