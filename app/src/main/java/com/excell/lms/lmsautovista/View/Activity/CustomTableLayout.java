...
public class CustomTableLayout extends AppCompatActivity implements HorizontalScroll.ScrollViewListener, VerticalScroll.ScrollViewListener {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_table_layout);
     ...
     /*   for(int i=0; i<9; i++){
        ...
        */
                    ...
                    public void onResponse(PocStockCountBean response) {
                        ...
                        try {
                            if (response.getPoc_stock_count().size() > 0) {
                                  ...
                                  //  for(int j=0; j<tableColumnCountB; j++){
                                        ...
                                        int size = response.getPoc_stock_count().size();
                                         ...
                                         //   addColumnToTableAtD(i, "D "+ ik + " " + j +" " );
                                             ...
                                             Toast.makeText(CustomTableLayout.this, ik +" /" +size, Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(CustomTableLayout.this, "No Record Found", Toast.LENGTH_SHORT).show();
                            }
        ...
        Utilities.getRequestQueue(CustomTableLayout.this).add(gsonRequest);
    }
