...
import com.excell.lms.lmsautovista.Presenter.LeadReportPresenter;
...
public class LeadReportFragment extends Fragment implements IView.ILeadReportView{
    ...
    @BindView(R.id.busyValueReport_textView)
    TextView busyValueReport_textView;
    ...
    @BindView(R.id.lost_to_codealerReportHeading_textView)
    TextView lost_to_codealerReportHeading_textView;

    LeadReportPresenter leadReportPresenter;
    String selectedLocation, selectedLocationId, locationId;
    ...
    private void initialiseUI(){
        ...
        undecidedValueReport_textView.setVisibility(View.GONE);
        not_interestedValueReport_textView.setVisibility(View.VISIBLE);
        busyValueReport_textView.setVisibility(View.VISIBLE);
        lost_to_codealerValueReport_textView.setVisibility(View.VISIBLE);
        color_model_availabilityValueReport_textView.setVisibility(View.GONE);
        budget_issueValueReport_textView.setVisibility(View.GONE);
        nearest_dealershipValueReport_textView.setVisibility(View.GONE);
        outstation_purchaseValueReport_textView.setVisibility(View.GONE);
        plan_cancelValueReport_textView.setVisibility(View.GONE);
        showroom_visitValueReport_textView.setVisibility(View.GONE);
        test_driveValueReport_textView.setVisibility(View.GONE);
        evaluation_allottedValueReport_textView.setVisibility(View.GONE);
        dealValueReport_textView.setVisibility(View.GONE);
        booked_from_autovistaValueReport_textView.setVisibility(View.GONE);
        home_visitValueReport_textView.setVisibility(View.GONE);
        lost_to_codealerReportHeading_textView.setText("Lost To Co-Dealer");
    ...
    public void searchLead(){
        try {
            locationId = SharedPreferenceManager.getInstance(getActivity()).getPreference(Constants.LOCATION_ID, "");
           ...
           // if (!(selectedLocation.toString().equals("Location"))) {
                if (!(fromDateLeadReport_TextView.getText().toString().equals(""))) {
                    if (!(toDateLeadReport_TextView.getText().toString().equals(""))) {
                        leadReportPresenter.getSearchVialOcationList(locationId, fromdate, toDate, getActivity());
                    } else {
        ...
        if (jsonObject.getTotal_feedback().size()>0){
         /*   undecidedValueReport_textView.setText(jsonObject.getTotal_feedback().get(0).getUndecided());
            ...
            */
            ...
            lost_to_codealerValueReport_textView.setText(jsonObject.getTotal_feedback().get(0).getLost_to_co_dealer());
            not_interestedValueReport_textView.setText(jsonObject.getTotal_feedback().get(0).getInterested());
            busyValueReport_textView.setText(jsonObject.getTotal_feedback().get(0).getBusy());
