...
import com.excell.lms.lmsautovista.View.Adapter.NewDashboardDetailAdapter;
...
public class NewLeadDashboardActivity extends AppCompatActivity implements IView.DashboardDetailView{
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(this)) {
            ...
            dashboardPresenter.getNewDashboardDetailList(role, user_id,NewLeadDashboardActivity.this);
        } else {
