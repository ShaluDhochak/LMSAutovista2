...
public class EvaluationDashboardAdapter extends RecyclerView.Adapter<EvaluationDashboardAdapter.MyViewHolder>{

    private List<CallingTaskNewLeadBean.Lead_Details> dashboardList;
    Context context;

    public EvaluationDashboardAdapter(Context context,List<CallingTaskNewLeadBean.Lead_Details> dashboardList){
        this.context = context;
        this.dashboardList = dashboardList;
    }

    @Override
    public EvaluationDashboardAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.followup_detail_listview, parent, false);
        return new EvaluationDashboardAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(EvaluationDashboardAdapter.MyViewHolder holder,final int position) {
