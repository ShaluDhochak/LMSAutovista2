...
import com.excell.lms.lmsautovista.View.Adapter.EscalationLevel1Adapter;
...
public class EscalationLevel1Activity extends AppCompatActivity  implements IView.DashboardDetailView{
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(this)) {
            ...
            dashboardPresenter.getEscalationLevel1DashboardList(role, user_id,EscalationLevel1Activity.this);
        } else {
            Toast.makeText(EscalationLevel1Activity.this, "Check Internet connectivity.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void ShowDashboardDetailCount(CallingTaskNewLeadBean jsonObject) {
        try {
            ...
            EscalationLevel1Adapter dashboardAdapter = new EscalationLevel1Adapter(EscalationLevel1Activity.this, jsonObject.getLead_details());
            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(EscalationLevel1Activity.this, LinearLayoutManager.VERTICAL, false);
