...
import com.excell.lms.lmsautovista.View.Adapter.UnassignedDashboardDetailAdapter;
...
public class UnassignedDashboardLeadActivity extends AppCompatActivity implements IView.DashboardDetailView{
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(this)) {
            ...
            dashboardPresenter.getUnassignedDashboardDetailList(role, user_id,UnassignedDashboardLeadActivity.this);
        } else {
