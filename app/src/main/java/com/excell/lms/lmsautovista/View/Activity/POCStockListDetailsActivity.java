...
public class POCStockListDetailsActivity extends AppCompatActivity {
    ...
    POCStockCountDetailListBean.Poc_Stock_List bean;
    ...
    @BindView(R.id.vehicleStatusStockLocationDetailsString_TextView)
    TextView vehicleStatusStockLocationDetailsString_TextView;
    ...
    private void initialiseUI(){
        ...
        vehicleStatusStockLocationDetailsString_TextView.setText(bean.getVehicle_status());
    }
