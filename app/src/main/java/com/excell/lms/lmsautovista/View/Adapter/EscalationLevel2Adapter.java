...
public class EscalationLevel2Adapter extends RecyclerView.Adapter<EscalationLevel2Adapter.MyViewHolder>{

    private List<CallingTaskNewLeadBean.Lead_Details> dashboardList;
    Context context;

    public EscalationLevel2Adapter(Context context,List<CallingTaskNewLeadBean.Lead_Details> dashboardList){
        this.context = context;
        this.dashboardList = dashboardList;
    }

    @Override
    public EscalationLevel2Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.followup_detail_listview, parent, false);
        return new EscalationLevel2Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(EscalationLevel2Adapter.MyViewHolder holder,final int position) {
