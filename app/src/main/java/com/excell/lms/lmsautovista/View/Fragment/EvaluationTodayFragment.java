...
public class EvaluationTodayFragment extends Fragment implements IView.NewLeadCallingTaskView{
    ...
    public EvaluationTodayFragment() {
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(getActivity())) {
            newLeadCallingTaskPresenter.getEvaluationVisitList(getActivity());
        } else {
