...
public class TestDriveDashboardActivity extends AppCompatActivity implements IView.DashboardDetailView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lmsheading_TextView.setText("Test Drive Leads");
        //  bean = UnassignedLeadDashboardActivity.this.getIntent().getParcelableExtra("bean");
        dashboardPresenter = new DashboardDetailPresenter(TestDriveDashboardActivity.this);

        progressDialog = new ProgressDialog(TestDriveDashboardActivity.this);
    ...
    public void onResume() {
        ...
        if (NetworkUtilities.isInternet(this)) {
            ...
            dashboardPresenter.getTestDriveDashboardList(role, user_id,TestDriveDashboardActivity.this);
        } else {
            Toast.makeText(TestDriveDashboardActivity.this, "Check Internet connectivity.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void ShowDashboardDetailCount(CallingTaskNewLeadBean jsonObject) {
        try {
            ...
            PendingDashboardAdapter dashboardAdapter = new PendingDashboardAdapter(TestDriveDashboardActivity.this, jsonObject.getLead_details());
            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(TestDriveDashboardActivity.this, LinearLayoutManager.VERTICAL, false);
