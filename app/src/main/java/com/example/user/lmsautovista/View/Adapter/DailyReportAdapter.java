...
import com.example.user.lmsautovista.View.Activity.DailyReportDetailActivity;
...
public class DailyReportAdapter  extends BaseAdapter {
    ...
    public DailyReportAdapter(Context context, ArrayList<SearchTrackerListBean.User_Details> dailyLeadBeanList)
    {
