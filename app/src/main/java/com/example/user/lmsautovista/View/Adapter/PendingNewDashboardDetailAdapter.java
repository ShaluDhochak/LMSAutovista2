...
public class PendingNewDashboardDetailAdapter extends RecyclerView.Adapter<PendingNewDashboardDetailAdapter.MyViewHolder>{

    private List<DashboardLeadDetailBean.Lead_Details> dashboardList;
    Context context;

    public PendingNewDashboardDetailAdapter(Context context,List<DashboardLeadDetailBean.Lead_Details> dashboardList){
        this.context = context;
        this.dashboardList = dashboardList;
    }

    @Override
    public PendingNewDashboardDetailAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.followup_detail_listview, parent, false);
        return new PendingNewDashboardDetailAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(PendingNewDashboardDetailAdapter.MyViewHolder holder,final int position) {
