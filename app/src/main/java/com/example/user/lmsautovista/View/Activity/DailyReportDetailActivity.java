...
public class DailyReportDetailActivity extends AppCompatActivity {
    ...
    @BindView(R.id.TrackerDetails_TextView)
    TextView TrackerDetails_TextView;
    ...
    private void initialiseUI(){
        ...
        //header
        lmsheading_TextView.setText("Daily Report Details");
        TrackerDetails_TextView.setText("Details");
       ...
       //condition for showing booking days
        if ((bean.getDays60_booking().equals("90")) || (bean.getDays60_booking().equals(">60"))){
           ...
           // leadBookingTrackerDetail_TextView.setBackgroundColor(Color.parseColor("#196F3D"));
            ...
            leadBookingTrackerDetail_TextView.setVisibility(View.VISIBLE);
            leadBookingTrackerDetail_TextView.setText(bean.getDays60_booking() +  " Days");
         //   leadBookingTrackerDetail_TextView.setBackgroundColor(ContextCompat.getColor(this, R.color.red));
            leadBookingTrackerDetail_TextView.setTextColor(getResources().getColor(android.R.color.black));
        }else if (bean.getDays60_booking().equals("60")){
            leadBookingTrackerDetail_TextView.setVisibility(View.VISIBLE);
            leadBookingTrackerDetail_TextView.setText(bean.getDays60_booking() + " Days");
           // leadBookingTrackerDetail_TextView.setBackgroundColor(ContextCompat.getColor(this, R.color.yellow));
            leadBookingTrackerDetail_TextView.setTextColor(getResources().getColor(android.R.color.black));
