...
public class DashboardPresenter implements IPresenter.IDashboardPresenter{
    ...
    String new_lead,unassigend_leads,call_today,pending_newLeads,pending_followup;
    IView.DashboardView view;

    public DashboardPresenter(IView.DashboardView dashboardView) {
